...
3. Start the daemon from the published image in GitHub Container Registry (GHCR):
   ```
...
4. If the user is developing/contributing to PromptOps or wants to build from source, they can clone the PromptOps repository and build it locally instead:
   ```
